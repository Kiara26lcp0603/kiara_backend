...
class Mastermind
 COLORS = %w[red blue green yellow cyan magenta]
  ...
  def create_code
    puts 'Ingresa el código secreto (ejemplo: red blue green yellow cyan magenta):'
    input = gets.chomp.split
    if valid_code?(input)
      @code = input
      player_guess
    else
      puts 'Código no válido. Debe contener cuatro colores de la lista: red, blue, green, yellow, cyan, magenta.'
      create_code
    end
  end
  ...
  def get_player_guess
    puts 'Ingresa tu adivinanza (ejemplo: red blue green yellow cyan magenta):'
    input = gets.chomp.split
    if valid_code?(input)
      input
    else
      puts 'Adivinanza no válida. Debe contener cuatro colores de la lista: red, blue, green, yellow, cyan, magenta.'
      get_player_guess
    end
  end
